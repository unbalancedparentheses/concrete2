...
For the underlying layout story, see [LAYOUT_CONTRACT.md](../platform/LAYOUT_CONTRACT.md).
...
Validated wrappers do **not** make layout guarantees. See [LAYOUT_CONTRACT.md](../platform/LAYOUT_CONTRACT.md) section 4.
