...
[PRINCIPLES.md](../project/PRINCIPLES.md) #12. Bug 045 was a name-resolution defect; the
source restriction improves audit clarity but does not replace compiler-owned
semantic identity. See [DECISIONS.md](../project/DECISIONS.md) “No lexical value
shadowing.”
