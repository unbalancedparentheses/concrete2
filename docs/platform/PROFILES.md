...
For the five claim classes, see [CLAIM_TAXONOMY.md](../verification/CLAIM_TAXONOMY.md).
For the public guarantee statement, see [GUARANTEE_STATEMENT.md](../verification/GUARANTEE_STATEMENT.md).
For the canonical "claims today" surface, see [CLAIMS_TODAY.md](../verification/CLAIMS_TODAY.md).
...
`wrapping_*` / `saturating_*` — per [ARITHMETIC_POLICY.md](../language/ARITHMETIC_POLICY.md)
...
References: [MEMORY_GUARANTEES.md](../language/MEMORY_GUARANTEES.md), [GUARANTEE_STATEMENT.md](../verification/GUARANTEE_STATEMENT.md), [SAFETY.md](../language/SAFETY.md)
...
expressions remain blocked; [PROVABLE_V1.md](../verification/PROVABLE_V1.md) is canonical.
...
References: [PROOF_CONTRACT.md](../verification/PROOF_CONTRACT.md), [PROOF_THEOREM_SHAPES.md](../verification/PROOF_THEOREM_SHAPES.md), [PROVABLE_SUBSET.md](../verification/PROVABLE_SUBSET.md), [PROOF_SEMANTICS_BOUNDARY.md](../verification/PROOF_SEMANTICS_BOUNDARY.md), [PROOF_WORKFLOW.md](../verification/PROOF_WORKFLOW.md)
