...
60 positive test files across 9 categories, all passing. Plus 16 policy enforcement tests (11 negative + 5 boundary positive, trust-gate) and 10 negative adversarial tests (hostile code the compiler must reject):
