...
For active priorities and remaining work, see [ROADMAP.md](../../ROADMAP.md). For landed milestones, see [CHANGELOG.md](../../CHANGELOG.md). For the safety model (capabilities, trusted, Unsafe, proof boundary), see [SAFETY.md](../language/SAFETY.md). For feature admission criteria and language shape, see [DESIGN_POLICY.md](../project/DESIGN_POLICY.md) and [LANGUAGE_SHAPE.md](../language/LANGUAGE_SHAPE.md).
...
boundaries are in
[EVIDENCE_ARCHITECTURE.md](../verification/EVIDENCE_ARCHITECTURE.md); the canonical proposition
language is in [VERIFICATION_IR.md](../verification/VERIFICATION_IR.md).
...
[PROOF_AUDIT_PIPELINE.md](../verification/PROOF_AUDIT_PIPELINE.md). The short version:
...
[OBLIGATION_CORE.md](../verification/OBLIGATION_CORE.md) and ROADMAP Phase 3 (ObligationCore
...
[PROOF_AUDIT_PIPELINE.md](../verification/PROOF_AUDIT_PIPELINE.md):
...
- `ProofCore` extracts the authority-free, proof-eligible fragment (`Concrete/Proof/ProofCore.lean`)
- `Concrete/Proof/Proof.lean` defines formal evaluation semantics for the admitted authority-free Core fragment and proves properties over it
...
[PROVABLE_SUBSET.md](../verification/PROVABLE_SUBSET.md) for the current
proof-eligible subset and
[PROOF_AUDIT_PIPELINE.md](../verification/PROOF_AUDIT_PIPELINE.md) for the target
pipeline.
...
**Formal semantics** (`Concrete/Proof/Proof.lean`) define evaluation for the
admitted authority-free Core fragment. `PROVABLE_V1.md` is the canonical
...
**Status:** Started. `Concrete/Proof/Proof.lean` defines evaluation semantics and
kernel theorems for the admitted authority-free Core fragment;
`Concrete/Proof/ProofCore.lean` extracts the proof-eligible subset from
...
| 11 | A10 | Formal kernel proofs | `Concrete/Proof/Proof.lean`, `Concrete/Proof/ProofCore.lean` | **Started** (named `ProvableV1` subset; generated coverage remains partial) |
