...
Audited and closed; see [PHASE3_OBLIGATION_CORE_AUDIT.md](../verification/PHASE3_OBLIGATION_CORE_AUDIT.md)
...
Audited and closed; see [PHASE4_COMPILER_LEDGER_AUDIT.md](../verification/PHASE4_COMPILER_LEDGER_AUDIT.md)
...
- Predictable boundaries documented: `docs/platform/PREDICTABLE_BOUNDARIES.md`,
  `docs/platform/PREDICTABLE_FAILURE_DISCIPLINE.md`, `docs/language/FAILURE_STRATEGY.md`
...
- Diagnostic UX design (`docs/compiler/DIAGNOSTIC_UX.md`)
- Trusted boundary guide (`docs/verification/TRUSTED_BOUNDARY_GUIDE.md`)
- Freestanding split defined (`docs/platform/FREESTANDING_SPLIT.md`,
  `docs/project/STANDALONE_VS_PROJECT.md`, `docs/project/PROJECT_BOOTSTRAP.md`)
...
layout/ABI contract (`docs/platform/LAYOUT_CONTRACT.md`), module hygiene, canonical
