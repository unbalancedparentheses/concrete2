...
For the safety model enforced by these passes, see [SAFETY.md](../language/SAFETY.md).
...
- `ProofCore` extracts the authority-free, proof-eligible fragment from validated Core (`Concrete/Proof/ProofCore.lean`)
- `Concrete/Proof/Proof.lean` defines evaluation semantics for the admitted authority-free Core fragment and proves properties over it
