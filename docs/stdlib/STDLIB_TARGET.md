...
For the execution model layers (core / alloc / hosted), see [EXECUTION_MODEL.md](../language/EXECUTION_MODEL.md).
For Phase 3 exit criteria, see [PHASE_EXIT_CHECKLISTS.md](../compiler/PHASE_EXIT_CHECKLISTS.md).
