...
Source: [STDLIB_TARGET.md](STDLIB_TARGET.md), [STDLIB_AUDIT.md](STDLIB_AUDIT.md), [ERROR_HANDLING_DESIGN.md](../language/ERROR_HANDLING_DESIGN.md)
...
Source: [ERROR_HANDLING_DESIGN.md](../language/ERROR_HANDLING_DESIGN.md)
...
Source: [BYTE_CURSOR_API.md](../language/BYTE_CURSOR_API.md), [ARITHMETIC_POLICY.md](../language/ARITHMETIC_POLICY.md), [STDLIB_TARGET.md](STDLIB_TARGET.md)
...
Source: [STDLIB_TARGET.md](STDLIB_TARGET.md), [STRING_TEXT_CONTRACT.md](../language/STRING_TEXT_CONTRACT.md)
...
Experimental because the relationship between `Text`, `&String`, and the borrow checker is not fully settled. See open question on `Text` vs `&str` in [STRING_TEXT_CONTRACT.md](../language/STRING_TEXT_CONTRACT.md).
...
Source: [STDLIB_API_REVIEW.md](STDLIB_API_REVIEW.md), [VISIBILITY_AND_MODULE_HYGIENE.md](../language/VISIBILITY_AND_MODULE_HYGIENE.md)
...
|------|-------------|------------|
| `let Type::Variant { fields } = expr;` | Irrefutable enum destructuring | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| `let StructType { fields } = expr;` | Irrefutable struct destructuring | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| `let Type::Variant { fields } = expr else { diverging_body };` | Refutable destructuring with else | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| Elaboration-time generic inference | Omit type params when context provides them | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) #1, #4 |
...
|------|--------|-----------|
| Closures / anonymous functions | Permanent exclusion: hidden capture, hidden data flow | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| `async` / `await` | No async runtime; permanent for hidden runtimes | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| Macros | Permanent exclusion: breaks phase separation and auditability | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| Operator overloading | Permanent for first release: hidden effects | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| Default function arguments | Hidden parameters; deferred | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| String interpolation | Requires macros or special parser form; deferred | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) |
| `for x in collection` | Requires iterator protocol; deferred | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) #18 |
| Compound assignment (`+=`, `-=`) | Low priority sugar; deferred | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) #20 |
| Guard clauses in match | Grammar ambiguity with `if`; deferred | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| Nested patterns in match/let | Complexity; deferred | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| `_` wildcard in destructuring | Can be added without grammar changes; deferred | [PATTERN_DESTRUCTURING.md](../language/PATTERN_DESTRUCTURING.md) |
| Byte-string literals (`b"..."`) | Byte/string boundary not settled; deferred | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) #8 |
| Raw strings (`r"..."`) | Deferred | [STRING_TEXT_CONTRACT.md](../language/STRING_TEXT_CONTRACT.md) |
| Multi-line strings | Deferred | [STRING_TEXT_CONTRACT.md](../language/STRING_TEXT_CONTRACT.md) |
| Pre/post conditions (`requires`/`ensures`) | Proof pipeline not mature; deferred | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| `comptime` evaluation | Blurs parse-time/run-time boundary; deferred | [ANTI_FEATURES.md](../language/ANTI_FEATURES.md) |
| `pub(pkg)` visibility | Deferred until package management | [VISIBILITY_AND_MODULE_HYGIENE.md](../language/VISIBILITY_AND_MODULE_HYGIENE.md) |
| Unifying `#` with `::` | Deferred pending user feedback | [SYNTAX_FREEZE_REVIEW.md](../compiler/SYNTAX_FREEZE_REVIEW.md) #10 |
...
Source: [ARITHMETIC_POLICY.md](../language/ARITHMETIC_POLICY.md)
...
Source: [STRING_TEXT_CONTRACT.md](../language/STRING_TEXT_CONTRACT.md), [STDLIB_DESIGN_PRINCIPLES.md](STDLIB_DESIGN_PRINCIPLES.md) Principle 4
...
Source: [HOSTED_STDLIB_SPLIT.md](HOSTED_STDLIB_SPLIT.md), [ANTI_FEATURES.md](../language/ANTI_FEATURES.md)
...
Full rationale for each: [ANTI_FEATURES.md](../language/ANTI_FEATURES.md), [STDLIB_TARGET.md](STDLIB_TARGET.md) (out-of-scope section).
