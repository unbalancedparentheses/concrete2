...
- Listed in `docs/project/EXAMPLE_INVENTORY.md` with owning phase, claim, and oracle strategy
...
3. Add to `docs/project/EXAMPLE_INVENTORY.md` at the pressure level
