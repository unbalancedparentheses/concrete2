...
hand-written Lean proof we link to [PROOFKIT_GUIDE.md](../verification/PROOFKIT_GUIDE.md) rather
...
Lean. Write it with the ProofKit ([PROOFKIT_GUIDE.md](../verification/PROOFKIT_GUIDE.md)), then
...
[EVIDENCE_CLASSES.md](../verification/EVIDENCE_CLASSES.md).
...
See [CONTRACTS_GUIDE.md](../language/CONTRACTS_GUIDE.md) for the reference on each construct
and [PROOFKIT_GUIDE.md](../verification/PROOFKIT_GUIDE.md) for writing the Lean proofs.
