...
[EXECUTION_MODEL.md](../language/EXECUTION_MODEL.md); the pull-trigger is ROADMAP Phase 7 item
H6 (attached to H3, IO honesty). Written so the approach is not re-derived or
mis-scoped later. Companion to [TESTING.md](../compiler/TESTING.md).
...
values deterministic artifacts (see [DETERMINISM.md](../compiler/DETERMINISM.md)) — this reuses
