...
Policy files and assumption files (`docs/verification/ASSUMPTION_FILES.md`) look
...
[EVIDENCE_ARCHITECTURE.md](../verification/EVIDENCE_ARCHITECTURE.md).
...
- `docs/verification/ASSUMPTION_FILES.md` — the descriptive sibling of this file.
  Same enforcement shape, different intent.
- `docs/verification/VERIFY_GATES.md` — pass-by-pass verify gates apply the same
  never-delete discipline.
- `docs/verification/WRONG_CODE_CORPUS.md` — drift in wrong-code regressions
