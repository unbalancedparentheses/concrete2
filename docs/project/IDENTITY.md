...
For feature admission criteria, see [DESIGN_POLICY.md](DESIGN_POLICY.md). For recorded "no" and "not yet" decisions, see [DECISIONS.md](DECISIONS.md). For long-term shape commitments, see [LANGUAGE_SHAPE.md](../language/LANGUAGE_SHAPE.md).
...
3. trust boundaries
4. evidence scope, method, status, and trust
...
1. a small authority-free or tightly-bounded core
...
Every proposed feature must pass a checklist (see [DESIGN_POLICY.md](DESIGN_POLICY.md) and [../research/meta/design-filters.md](../../research/meta/design-filters.md)):
