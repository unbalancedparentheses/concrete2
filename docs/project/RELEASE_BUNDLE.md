...
Sibling to `docs/project/BUG_BUNDLE.md`:
...
- `docs/project/BUG_BUNDLE.md` — failing-program sibling.
- `docs/project/POLICY_FILES.md`, `docs/verification/ASSUMPTION_FILES.md` — the
