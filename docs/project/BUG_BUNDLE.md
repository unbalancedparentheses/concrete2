...
2. Add a manifest entry per the wrong-code corpus contract
   (`docs/verification/WRONG_CODE_CORPUS.md`). The bundle's
...
- `docs/verification/WRONG_CODE_CORPUS.md` — the manifest schema and lifecycle.
- `docs/compiler/REDUCER_WORKFLOW.md` — the reducer that feeds this pipeline.
