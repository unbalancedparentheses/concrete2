...
- [ARITHMETIC_POLICY.md](../language/ARITHMETIC_POLICY.md) — integer and bounds semantics
- [PREDICTABLE_BOUNDARIES.md](../platform/PREDICTABLE_BOUNDARIES.md) — compiled/profile
  execution boundary
