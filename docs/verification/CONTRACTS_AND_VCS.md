...
- `docs/verification/PROVABLE_V1.md` defines the current subset that can carry
  Lean-backed value-semantics evidence.
- `docs/verification/PROOF_STORY_MATRIX.md` is the language-level no-dark-constructs
  inventory.
- `docs/verification/PROOF_OBLIGATIONS_REGISTER.md` tracks ProofCore extraction and
