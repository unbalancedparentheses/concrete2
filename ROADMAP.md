...
40. add a per-phase exit checklist for the active roadmap, starting with Predictable Core: each phase should have a small “phase closes when…” list tied to concrete outputs such as example inventory coverage, docs, reports, and tests so the roadmap cannot drift into never-finished thematic work
