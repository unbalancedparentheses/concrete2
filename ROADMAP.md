...
14. prove selected user-facing functions and report properties — done when the project can demonstrate end-to-end proof-backed evidence on a meaningful restricted fragment
