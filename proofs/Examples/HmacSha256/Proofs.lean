...
def shaFns : FnTable :=
  ...
  FnTable.withAttestations
    ...
    [ AttestedPFnDef.of shaBigSigma0Fn     Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_big_sigma0
    , AttestedPFnDef.of shaBigSigma1Fn     Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_big_sigma1
    , AttestedPFnDef.of shaBlockToWordsFn  Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_block_to_words
    , AttestedPFnDef.of shaBlockToWordsAtFn Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_block_to_words_at
    , AttestedPFnDef.of shaChFn            Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_ch
    , AttestedPFnDef.of shaMajFn           Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_maj
    , AttestedPFnDef.of shaCompressAtFn    Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_compress_at
    , AttestedPFnDef.of shaHashFn          Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_hash
    , AttestedPFnDef.of shaInitFn          Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_init
    , AttestedPFnDef.of shaKFn             Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_k
    , AttestedPFnDef.of shaRoundFn         Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_round
    , AttestedPFnDef.of shaScheduleFn      Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_sha256_schedule
    , AttestedPFnDef.of shaSmallSigma0Fn   Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_small_sigma0
    , AttestedPFnDef.of shaSmallSigma1Fn   Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_small_sigma1
    , AttestedPFnDef.of shaStateToBytesFn  Concrete.Proof.GeneratedAttestations.shaFns_5e65bafc_state_to_bytes ]
