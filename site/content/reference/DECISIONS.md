...
desugaring. Concrete keeps `Result` and its ordinary library combinators; it rejects implicit
propagation, implicit error conversion, implicit drop, and hidden capability use.
