...
declare -A SKIP_BUGS=(
  ...
  [064]="OPEN -- an imported type behind an alias does not resolve as that type (E0254 on a field access); the unaliased control gives E0298 privacy, proving the alias alone breaks resolution. Blocks R-0004 imported field/variant identity"
