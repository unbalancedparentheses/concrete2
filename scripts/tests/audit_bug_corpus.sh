...
declare -A SKIP_BUGS=(
  ...
  [065]="OPEN -- builtinEnumList is constructed twice (Elab.lean:1632, Check.lean:2121) with the same hasUserResult conditional; one fact in two places, so Check and Elab could disagree about what Result is"
