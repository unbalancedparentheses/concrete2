...
- Continue shifting semantic authority toward validated Core IR, with `CoreCheck` already owning more Core capability enforcement, return-type checking, and match validation
